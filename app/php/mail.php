...
// configure
$from = 'info@thefizzical.co.uk';
$sendTo = 'info@thefizzical.co.uk';
$subject = 'Package enquiry for The Fizzical Co';
...
try
{
    $emailText = nl2br("You have new enquiry from Fizzical Co Website:\n\n");
